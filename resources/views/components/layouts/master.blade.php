...
<head>
    ...
    <title>@yield('title', 'JaveaDream: Your Gateway to a Dream Vacation in Javea, Spain')</title>
    <meta name="description" content="@yield('description', 'Discover sun-drenched charm in Javea with JaveaDream.es. Explore exquisite holiday rentals in this picturesque Spanish town, ideal for families, couples, and solo travelers seeking comfort and style.')"> @include('includes.styles')
