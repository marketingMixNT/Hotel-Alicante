                    ...
                    <div class="gdlr-core-pbf-wrapper" style="margin: 0px 0px 0px 0px; padding: 200px 0px 150px 0px;" id="gdlr-core-wrapper-1">
                        <div class="gdlr-core-pbf-background-wrap">
                            <div
                                ...
                                style="background-image: url(upload/home-hotel-hero-bg.jpg); background-size: cover; background-position: center;"
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                                                    <div class="gdlr-core-title-item-title-wrap">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title class-test" style="font-size: 96px; font-weight: 200; letter-spacing: 4px; text-transform: none; color: #ffffff;">
                                                            Book Your <span style="font-weight: 500;">Stay</span><span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                        </h3>
                                                    </div>
                                                    <span
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="tourmaster-room-search-item tourmaster-item-pdlr clearfix">
                                                    <form
                                                        class="tourmaster-room-search-form tourmaster-radius-normal tourmaster-style-box tourmaster-align-horizontal"
                                                        action="https://demo.goodlayers.com/hotale/hotel1/room-search/"
                                                        method="get"
                                                    >
                                                                    ...
                                                                    >
                                                                        <div class="tourmaster-room-thumbnail tourmaster-media-image gdlr-core-outer-frame-element">
                                                                            <a href="single-room.html">
                                                                                <img
                                                                                    src="upload/andrew-neel-T0eb55DxDN4-unsplash-780x595.jpg"
                                                                                    alt=""
                                                                                    width="780"
                                                                                    height="595"
                                                                                />
                                                                        ...
                                                                        <div class="tourmaster-room-content-wrap gdlr-core-skin-e-background gdlr-core-js" data-sync-height="room-item-6" style="padding-top: 75px; padding-bottom: 45px;">
                                                                            <div class="tourmaster-price-wrap tourmaster-with-bg"><span class="tourmaster-head">From</span><span class="tourmaster-price">$90</span></div>
