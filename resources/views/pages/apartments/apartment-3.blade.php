...
{{-- @section('title', '')
    ...
    <x-breadcrumbs title="Rennes Areal 3" bgi="{{ asset('assets/images/rennes-3/rennes_11.webp') }}" />

    <x-apartment.template title="Rennes Areal 3" price="99 EUR" galleryHref="{{route('gallery-apartment-3')}}">

        <x-slot name="thumbnail">
            <x-apartment.thumbnail img="{{ asset('assets/images/rennes-3/rennes_25.webp') }}" />
        </x-slot>
        ...
        <x-slot name="gallery">
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-3/rennes_1.webp')}}"/>
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-3/rennes_26.webp')}}"/>
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-3/rennes_30.webp')}}"/>
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-3/rennes_34.webp')}}"/>
