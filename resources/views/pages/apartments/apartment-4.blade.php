<x-layouts.master>
    ...
    <x-breadcrumbs title="Rennes Areal 6" bgi="{{ asset('assets/images/rennes-6/renes_16.webp') }}" />

    <x-apartment.template title="Rennes Areal 6" price="99 EUR" galleryHref="{{route('gallery-apartment-4')}}">

        <x-slot name="thumbnail">
            <x-apartment.thumbnail img="{{ asset('assets/images/rennes-6/renes_27.webp') }}" />
        </x-slot>
        ...
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-6/renes_1.webp')}}"/>
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-6/renes_15.webp')}}"/>
        <x-apartment.galleryItem src="{{asset('assets/images/rennes-6/renes_29.webp')}}"/>
